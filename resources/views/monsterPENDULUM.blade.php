						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas de Monstruo Péndulo</h2>
										</header>

									
										<div class="row">

										@foreach($monstersPENDULUM as $monsterPENDULUM)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$monsterPENDULUM['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$monsterPENDULUM['nombre']}}</h3>
													</header>
													<p>{{$monsterPENDULUM['categoria']}}</p>
													<p>{{$monsterPENDULUM['descripcion']}}</p>
													<footer>
													</footer>
