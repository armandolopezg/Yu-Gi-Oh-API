						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Trampa Normales</h2>
										</header>

									
										<div class="row">

										@foreach($trapsNormal as $trapNormal)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$trapNormal['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$trapNormal['nombre']}}</h3>
													</header>
													<p>{{$trapNormal['categoria']}}</p>
													<p>{{$trapNormal['descripcion']}}</p>
													<footer>
													</footer>
