						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Mágicas de Juego Rápido</h2>
										</header>

									
										<div class="row">

										@foreach($spellsQuickPlay as $spellQuickPlay)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$spellQuickPlay['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$spellQuickPlay['nombre']}}</h3>
													</header>
													<p>{{$spellQuickPlay['categoria']}}</p>
													<p>{{$spellQuickPlay['descripcion']}}</p>
													<footer>
													</footer>
