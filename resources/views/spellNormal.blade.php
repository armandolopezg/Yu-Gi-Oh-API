						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Mágicas Normales</h2>
										</header>

									
										<div class="row">

										@foreach($spellsNormal as $spellNormal)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$spellNormal['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$spellNormal['nombre']}}</h3>
													</header>
													<p>{{$spellNormal['categoria']}}</p>
													<p>{{$spellNormal['descripcion']}}</p>
													<footer>
													</footer>
