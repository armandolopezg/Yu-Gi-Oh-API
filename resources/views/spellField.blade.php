						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Mágicas de Campo</h2>
										</header>

									
										<div class="row">

										@foreach($spellsField as $spellField)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$spellField['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$spellField['nombre']}}</h3>
													</header>
													<p>{{$spellField['categoria']}}</p>
													<p>{{$spellField['descripcion']}}</p>
													<footer>
													</footer>
