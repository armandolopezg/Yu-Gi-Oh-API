									...
									<section>
										...
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$monsterF['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$monsterF['nombre']}}</h3>
													</header>
													<p>{{$monsterF['categoria']}}</p>
													<p>{{$monsterF['descripcion']}}</p>
													<footer>
													</footer>
