						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Mágicas de Equipo</h2>
										</header>

									
										<div class="row">

										@foreach($spellsEquip as $spellEquip)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$spellEquip['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$spellEquip['nombre']}}</h3>
													</header>
													<p>{{$spellEquip['categoria']}}</p>
													<p>{{$spellEquip['descripcion']}}</p>
													<footer>
													</footer>
