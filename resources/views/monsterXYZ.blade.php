						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas de Monstruo XYZ</h2>
										</header>

									
										<div class="row">

										@foreach($monstersXYZ as $monsterXYZ)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$monsterXYZ['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$monsterXYZ['nombre']}}</h3>
													</header>
													<p>{{$monsterXYZ['categoria']}}</p>
													<p>{{$monsterXYZ['descripcion']}}</p>
													<footer>
													</footer>
