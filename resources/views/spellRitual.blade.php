						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Mágicas de Ritual</h2>
										</header>

									
										<div class="row">

										@foreach($spellsRitual as $spellRitual)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$spellRitual['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$spellRitual['nombre']}}</h3>
													</header>
													<p>{{$spellRitual['categoria']}}</p>
													<p>{{$spellRitual['descripcion']}}</p>
													<footer>
													</footer>
