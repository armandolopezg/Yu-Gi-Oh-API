						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Trampa de Contraefecto</h2>
										</header>

									
										<div class="row">

										@foreach($trapsCounter as $trapCounter)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$trapCounter['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$trapCounter['nombre']}}</h3>
													</header>
													<p>{{$trapCounter['categoria']}}</p>
													<p>{{$trapCounter['descripcion']}}</p>
													<footer>
													</footer>
