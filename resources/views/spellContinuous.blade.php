						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Mágicas Continuas</h2>
										</header>

									
										<div class="row">

										@foreach($spellsContinuous as $spellContinuous)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$spellContinuous['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$spellContinuous['nombre']}}</h3>
													</header>
													<p>{{$spellContinuous['categoria']}}</p>
													<p>{{$spellContinuous['descripcion']}}</p>
													<footer>
													</footer>
