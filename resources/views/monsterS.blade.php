						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas de Monstruo Synchro</h2>
										</header>

									
										<div class="row">

										@foreach($monstersS as $monsterS)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$monsterS['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$monsterS['nombre']}}</h3>
													</header>
													<p>{{$monsterS['categoria']}}</p>
													<p>{{$monsterS['descripcion']}}</p>
													<footer>
													</footer>
