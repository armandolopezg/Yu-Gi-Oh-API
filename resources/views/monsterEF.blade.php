						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas de Monstruo de Efecto</h2>
										</header>

									
										<div class="row">

										@foreach($monstersEF as $monsterEF)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$monsterEF['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$monsterEF['nombre']}}</h3>
													</header>
													<p>{{$monsterEF['categoria']}}</p>
													<p>{{$monsterEF['descripcion']}}</p>
													<footer>
													</footer>
