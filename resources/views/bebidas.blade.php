									...
									<section>
										...
										@foreach($bebidas as $bebida)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$bebida['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$bebida['categoria']}}</h3>
													</header>
													<p>{{$bebida['nombre']}}</p>
													<footer>
													</footer>
					...
					<div class="container">
							...
							<div class="col-12">
								...
								<!-- Copyright -->
									<div id="copyright">
										<ul class="links">
											<li>&copy; Yu-Gi-Oh! API</li><li>Página amiga de Bebidas<a href="http://bebidasapi.herokuapp.com/index"> Drink Up </a></li>
										</ul>
									</div>
