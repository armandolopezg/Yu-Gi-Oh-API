						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas Trampa Continuas</h2>
										</header>

									
										<div class="row">

										@foreach($trapsContinuous as $trapContinuous)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$trapContinuous['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$trapContinuous['nombre']}}</h3>
													</header>
													<p>{{$trapContinuous['categoria']}}</p>
													<p>{{$trapContinuous['descripcion']}}</p>
													<footer>
													</footer>
