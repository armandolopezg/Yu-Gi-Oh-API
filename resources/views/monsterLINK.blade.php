						...
						<div class="row">
							<div class="col-12">
								...
								<!-- Portfolio -->
									<section>
										<header class="major">
											<h2>Cartas de Monstruo Enlace</h2>
										</header>

									
										<div class="row">

										@foreach($monstersLINK as $monsterLINK)
										@if ($loop->index <= 101)
											...
											<section class="box">
													...
													<a href="#" class="image featured"><img src="{{$monsterLINK['imagen']}}" alt="" /></a>
													<header>
														<h3>{{$monsterLINK['nombre']}}</h3>
													</header>
													<p>{{$monsterLINK['categoria']}}</p>
													<p>{{$monsterLINK['descripcion']}}</p>
													<footer>
													</footer>
